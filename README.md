...
![Commercial License](https://img.shields.io/badge/License-Commercial-orange)
![Privacy](https://img.shields.io/badge/Privacy-Local%20First-green)
![PWA](https://img.shields.io/badge/PWA-%E2%9C%93-purple)
...
Use the full suite immediately at **[SigmaExacta.com](https://sigmaexacta.com)**.

### Install as a PWA (Progressive Web App)

1. Visit [SigmaExacta.com](https://sigmaexacta.com) in a modern browser (Chrome, Edge, Safari, etc.)
...
[GNU Affero General Public License v3](LICENSE-AGPL.txt).

> ⚠️ If you deploy a modified version over a network (e.g., a website or SaaS service),
...
- Internal use where source disclosure is acceptable

### Commercial License

If you want to use Sigma Exacta in a **proprietary or commercial context** without the
AGPL obligations, a commercial license is available. It permits:

- ✅ Integration into closed-source or proprietary products
- ✅ Distribution of modified versions without source disclosure
- ✅ Deployment as a SaaS or network service without source disclosure

Commercial licenses are negotiated individually based on use case, deployment scale,
and organization size.

> 📩 **Contact:** contact@sigmaexacta.com
> 🌐 **Website:** [sigmaexacta.com](https://sigmaexacta.com)

See [LICENSE-COMMERCIAL.txt](LICENSE-COMMERCIAL.txt) for the full terms.
...
These tools are provided for educational and professional support purposes. This software
implements various industrial methodologies (including but not limited to APQP, PPAP, FMEA,
TRIZ, Taguchi, QFD, EFQM, and others). The intellectual property rights to these
methodologies belong to their respective creators and standardization bodies. This project
is an independent software implementation and is not affiliated with, endorsed by, or
sponsored by any of these organizations.

The authors and contributors assume no responsibility or liability for any decisions,
actions, or outcomes resulting from the use of this software. Users are solely responsible
for verifying calculations, validating results, and making their own professional
