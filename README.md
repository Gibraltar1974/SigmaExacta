...
1.  Clone the repository:
    ```bash
    git clone [https://github.com/Gibraltar1974/SigmaExacta.git](https://github.com/Gibraltar1974/SigmaExacta.git)
    ```
...
```text
[https://sigmaexacta.com/cpk_calculator.html?data=10.2,10.5,9.8,10.1&lsl=9.0&usl=11.0&target=10.0&auto_calculate=1](https://sigmaexacta.com/cpk_calculator.html?data=10.2,10.5,9.8,10.1&lsl=9.0&usl=11.0&target=10.0&auto_calculate=1)
Example (Taguchi DOE):

Plaintext

[https://sigmaexacta.com/taguchi_doe.html?experiment-name=TestRun&factors=Temp](https://sigmaexacta.com/taguchi_doe.html?experiment-name=TestRun&factors=Temp)|Press&levels=Low,High|10psi,20psi&array=L4&auto_calculate=1
📄 License
